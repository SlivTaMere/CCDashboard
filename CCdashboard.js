    ...
    function r() {
        ...
        function l(e, t, a, i, l, s, d, p, m, u, h, g, v, f, x, y, b, w, L) {
            var k = w ? "https://s2.coinmarketcap.com/static/img/coins/64x64/" + w + ".png" : "https://files.coinmarketcap.com/static/widget/coins_legacy/64x64/" + e + ".png",
                C = "#009e73";
            m < 0 && (C = "#d94040"), m = r.toLocaleString(m, {
                minDecimalPlaces: 2,
                maxDecimalPlaces: 2
            }), valTickerHTML = v ? "(" + a + ")" : "", valPrice = s ? o(s, i) : "?", valPercentHTML = m ? '<span style="color:' + C + '">(' + m + "%)" : "", valMarketCap = u ? n(u, 2) : "?", valVolume = h ? n(h, 2) : "?", poweredBy = "zh" == L ? "ç”±CoinMarketCapè£å¹¸å‘ˆçŽ°" : "Powered by CoinMarketCap", d ? (mainLineHeight = 25, valPriceSecondary = p ? o(p, d) : "?", secondaryHTML = '<br><span style="font-size: 12px; color: rgba(200, 200, 200, 1)">' + valPriceSecondary + " " + d + " </span>") : (mainLineHeight = 30, secondaryHTML = "");
            ...
            e(".coinmarketcap-currency-widget").each(function() {
                ...
                c = currencyid ? "https://3rdparty-apis.coinmarketcap.com/v1/cryptocurrency/widget?id=" + currencyid + "&convert=BTC,USD," + i : "https://widgets.coinmarketcap.com/v1/ticker/" + t + "/?ref=widget&convert=" + i, e.get({
                    ...
                    success: function(c) {
                        ...
                        var S = l(t, w, L, i, o, v, r, f, b, x, y, k, s, d, m, p, u, currencyid, n);
